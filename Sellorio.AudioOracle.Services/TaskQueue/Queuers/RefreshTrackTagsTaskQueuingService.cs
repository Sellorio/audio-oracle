...
internal class RefreshTrackTagsTaskQueuingService(DatabaseContext databaseContext, ITaskQueuingService taskQueuingService) : IRefreshTrackTagsTaskQueuingService
{
    public async Task QueueAsync(int trackId)
    {
        ...
        await taskQueuingService.QueueTaskAsync<Handlers.RefreshTrackTags>(trackId, null);
    }
}
