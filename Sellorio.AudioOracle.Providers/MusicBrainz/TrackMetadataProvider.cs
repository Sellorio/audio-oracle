    ...
    : ITrackMetadataProvider
{
    ...
    public async Task<ValueResult<TrackMetadata>> GetTrackMetadataAsync(ResolvedIds albumIds, ResolvedIds trackIds)
    {
        ...
        var recording = JsonSerializer.Deserialize<Recording>(json, Constants.JsonOptions);
        ...
        return new TrackMetadata
        {
            ...
            AlternateTitle = null,
            DownloadIds = null,
            ArtistSourceIds = recording.ArtistCredit.Select(x => x.Artist.Id.ToString()).ToArray(),
